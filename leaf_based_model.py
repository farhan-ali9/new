...
class LeafBasedModel:
    ...
    def __init__(self, path_features_folder, path_sentiment_folder, path_company_names, path_performance, end_date):
        ...
        self.data_all = {}  # Initialize data_all as an empty dictionary
        self.num_models = 0  # Initialize num_models with None
        self.leaves=[]
        self.firms=[]
        self.df_performance_test={}
        self.weights_SPI=[]
    ...
    def compute_threshold(self):
        ...
        firms = [company for company in self.firms if company not in company_to_remove]
    ...
    def compute_historical_performance(self):
    	...
    	print("Keys in self.data_all:", self.data_all.keys())
